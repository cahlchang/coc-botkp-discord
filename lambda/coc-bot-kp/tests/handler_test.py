...
# 正常なリクエストのテスト
def test_run_with_valid_request(mocker):
    # BotクラスのverifyメソッドがTrueを返すように設定
    ...
    mock_bot.verify.assert_called_once_with("valid_signature", "valid_timestamp", json.dumps({"type": 1}))
